...
<b>Bot Maintained By: @ML_Botupdates </b> \n 
<b> I Can Also Download/Upload Files From Zee5</b> \n
<b>Do /help for more Details ...</b> \n
"""

    RENAME_403_ERR = "What Are You Doing? Bruuh!!"
    BANNED_USER_TEXT = "Sorry!! But @ML_Botupdates Admins As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @ML_SupportGroup For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do,Mate?"
    UPGRADE_TEXT = "<b>Nothing Today Maybe Tomorrow😉😂</b> \n \n Contact : @BLuVDS "
    ...
    NOT_AUTH_USER_TEXT = "CONTACT @BLuVDS "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @BLuVDS "
